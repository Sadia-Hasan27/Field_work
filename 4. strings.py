...
s1= "Name:Samia, Age:30, Country:Bangladesh"
s2 = s1.split(", ")

name = s2[0].split(":")[1]
age = s2[1].split(":")[1]
country = s2[2].split(":")[1]
...
v= f"Hello, my name is {p1["Name"]}.\nI am {p1["Age"]} years old and a {p1["Occupation"]}."
print(v)
...
pat=r"#\w+"
hashtag=re.findall(pat, text_with_hashtags)
print(hashtag)
...
# 01845-567567
import re
t= "01454565767 or +880196345634 or 0088785674657 or 01845-567567"
pat= r"(?:\+880|00880|0)\d{9}|\d{4}-\d{6}"
result= re.findall(pat,t)
print(result)
